...
exports.hook_mail = function (next, connection, params) {
    ...
    if (this.in_host_list(domain, txn) || this.in_host_regex(domain, txn)) {
...
exports.in_host_list = function (domain, txn) {
    this.logdebug(`checking ${domain} in config/host_list`, txn);
...
exports.in_host_regex = function (domain, txn) {
    ...
    this.logdebug(`checking ${domain} against config/host_list_regex `, txn);
